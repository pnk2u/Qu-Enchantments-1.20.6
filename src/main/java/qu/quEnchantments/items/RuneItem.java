...
//    }
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        if (!stack.hasEnchantments() || entity.age % 20 != 0 /* || ((IItemStack)(Object)stack).corruptedLevel() > 0 */ ||
        ...
        if (CONFIG.breakOnNoDurability && entity instanceof LivingEntity livingEntity && stack.getDamage() >= stack.getMaxDamage()) {
            stack.damage(1, livingEntity, selected ? EquipmentSlot.MAINHAND : EquipmentSlot.OFFHAND);
        }
    }
}
